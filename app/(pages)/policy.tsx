  ...
  return (
    <ThemedView style={tw`w-full flex-1 px-5`}>
      <SafeAreaView style={tw`w-full flex-1`}>
        ...
        <View style={tw`mb-5`}>
          <ThemedText style={tw`text-4xl mb-5 font-medium w-70`}>
            Privacy & Policy
          </ThemedText>
          ...
          <ThemedText style={tw`mb-5 font-bold`}>Holon Labs Privacy & Policy Information</ThemedText>
          
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={tw`gap-5`}>
          <View>
            <ThemedText style={tw`mb-1 text-[#6C6C6C]`}>Introduction:</ThemedText>
            <ThemedText>
          ...
          <View>
            <ThemedText style={tw`mb-1 text-[#6C6C6C]`}>Overview:</ThemedText>
            <ThemedText>
              Lorem ipsum dolor sit amet consectetur. Sed in massa habitasse
              pellentesque a. Id in blandit eget et nulla arcu lobortis donec.
              Velit egestas proin risus nisl faucibus lobortis ullamcorper
          ...
          <View>
            <ThemedText style={tw`mb-1 text-[#6C6C6C]`}>Data Collection and uses:</ThemedText>
            <ThemedText>
              Lorem ipsum dolor sit amet consectetur. Sed in massa habitasse
              pellentesque a. Id in blandit eget et nulla arcu lobortis donec.
              Velit egestas proin risus nisl faucibus lobortis ullamcorper
          ...
          <View>
            <ThemedText style={tw`mb-1 text-[#6C6C6C]`}>Data Sharing and Disclosure:</ThemedText>
            <ThemedText>
              Lorem ipsum dolor sit amet consectetur. Sed in massa habitasse
              pellentesque a. Id in blandit eget et nulla arcu lobortis donec.
              Velit egestas proin risus nisl faucibus lobortis ullamcorper
          ...
          <View>
            <ThemedText style={tw`mb-1 text-[#6C6C6C]`}>Data Retention and Deletion:</ThemedText>
            <ThemedText>
              Lorem ipsum dolor sit amet consectetur. Sed in massa habitasse
              pellentesque a. Id in blandit eget et nulla arcu lobortis donec.
              Velit egestas proin risus nisl faucibus lobortis ullamcorper
